...
import com.rayburn.engine.dew.binding.DewPropertyBindingInt;
...
public abstract class WindowManager extends AbstractDewEntityBinding
{
	...
	protected DewPropertyBindingInt framerate         = new DewPropertyBindingInt("framerate", 60);
	...
	protected boolean isWindowActive = false;
	...
	public abstract void rUpdate();

	public abstract void rUpdate(int instancedFramerate);
	...
	public boolean getIsWindowActive()
	{
