package com.normalizedinsanity.rayburn.engine.util;
 ...
 * @date 12/19/13
 * @version 1.1
 * <p>Contains com.normalizedinsanity.rayburn.Rayburn utility constants, functions, and classes</p>
 */
public class MathUtil
{
	...
	/**
	 * Converts a camera based quaternion descriptor into a gl modelview rotation matrix
	 * @param q the camera's quaternion rotation descriptor
	 * @return modelview rotation matrix
	 */
	public static Matrix4f convertQuaternionToMatrix4f(Quaternion q)
	{
		Matrix4f matrix = getIdentityMatrix();
